...
- When a task requires creating or checking out a task branch, create a dedicated Git worktree for the current Claude Code session and do all branch-related work there. Do not switch a shared checkout to the task branch.
