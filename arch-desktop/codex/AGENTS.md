...
- In a managed task, Myriad assigns one branch and target for its repository. Stay on that branch for every commit there; never create, switch, merge, delete, or split branches in that assigned repository.
